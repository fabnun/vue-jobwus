const themes = {
  ...
  styles: {
    blueDark: {
      '--background': "url('/assets/dark4.jpg') black repeat center top",
      ...
      '--match-color': 'cyan',
      '--match2-background': 'rgba(0, 0, 0,.4)',
      '--match2-color': 'orange',
    ...
    blueLight: {
      '--background': "url('/assets/paper2.jpg') white repeat center top",
      '--color': 'rgba(20,30,40, 1)',
      '--background-input': 'white',
      '--background-color': 'black',
      '--font-size': '1.1em',
      '--match-color': 'green',
      '--match-background': 'rgba(0, 0, 0,.1)',
      '--match2-background': 'rgba(0, 0, 0,.1)',
      '--match2-color': 'red',
    ...
    brownDark: {
      '--background': "url('/assets/dark9.jpg') black repeat center top",
